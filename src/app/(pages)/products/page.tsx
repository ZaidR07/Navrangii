...
function ProductsPageContent() {
  ...
  return (
    <div className="min-h-screen bg-purple-50">
      <NavigationHeader />
      <div className="max-w-7xl xl:max-w-5xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-28 sm:mt-32 lg:mt-36">
        {/* Header */}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                          {subProducts.slice(0, 8).map((product) => (
                            <div
                              ...
                              className="transition-shadow duration-300 group cursor-pointer"
                            >
                              <div className="aspect-[4/5] w-full overflow-hidden relative bg-gray-100 border-4 border-gray-100 shadow group-hover:shadow-lg transition-shadow duration-300">
                                <Image
                              ...
                              <div className="p-3 text-center">
                                <h4 className="font-medium text-gray-800 text-base line-clamp-2 mb-1" onClick={(e) => { e.stopPropagation(); router.push(`/product/${product._id}`); }}>{product.name}</h4>
                                <p className="text-sm text-purple-600">
                                  {product.variants && product.variants.length > 0 ? (
                                    (() => {
                                      ...
                                      return (
                                        <>
                                          ₹{minPrice.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                          {minPrice !== maxPrice && (
                                            <span className="text-gray-400 font-normal"> - ₹{maxPrice.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                          )}
                                        </>
                                      );
                                    })()
                ...
                {filteredProducts.map((product) => (
                  ...
                  >
                    ...
                    <div className="p-4 text-center">
                      <h3 className="font-medium text-gray-800 text-lg line-clamp-2 mb-2" onClick={(e) => { e.stopPropagation(); router.push(`/product/${product._id}`); }}>{product.name}</h3>
